import {
  require_react_dom
} from "./chunk-75MRHHGD.js";
import {
  require_react
} from "./chunk-JJF4MBEU.js";
import {
  __async,
  __commonJS,
  __objRest,
...
function createRouter(init) {
  ...
  function completeNavigation(location, newState, { flushSync: flushSync2 } = {}) {
    ...
    updateState(
      __spreadProps(__spreadValues({}, newState), {
  ...
  function startNavigation(historyAction, location, opts) {
    return __async(this, null, function* () {
      ...
      let scopedContext = new unstable_RouterContextProvider(
        init.unstable_getContext ? yield init.unstable_getContext() : void 0
      );
      ...
      if (opts && opts.pendingError) {
        ...
        let actionResult = yield handleAction(
          request,
          location,
          opts.submission,
          matches,
  ...
  function handleAction(_0, _1, _2, _3, _4, _5, _6) {
    return __async(this, arguments, function* (request, location, submission, matches, scopedContext, isFogOfWar, initialHydration, opts = {}) {
      interruptActiveLoads();
      let navigation = getSubmittingNavigation(location, submission);
      updateState({ navigation }, { flushSync: opts.flushSync === true });
      if (isFogOfWar) {
        let discoverResult = yield discoverRoutes(
          matches,
          location.pathname,
          request.signal
        );
      ...
      if (!actionMatch.route.action && !actionMatch.route.lazy) {
        ...
        let results = yield callDataStrategy(
          request,
          dsMatches,
          scopedContext,
          null
  ...
  function handleLoaders(request, location, matches, scopedContext, isFogOfWar, overrideNavigation, submission, fetcherSubmission, replace2, initialHydration, flushSync2, pendingActionResult) {
    return __async(this, null, function* () {
      ...
      if (!init.dataStrategy && !dsMatches.some((m) => m.shouldLoad) && revalidatingFetchers.length === 0) {
        ...
        completeNavigation(
          ...
          }, getActionDataForCommit(pendingActionResult)), updatedFetchers2 ? { fetchers: new Map(state.fetchers) } : {}),
          { flushSync: flushSync2 }
        );
        return { shortCircuited: true };
      }
      ...
      let { loaderResults, fetcherResults } = yield callLoadersAndMaybeResolveData(
        dsMatches,
  ...
  function fetch2(key, routeId, href2, opts) {
    return __async(this, null, function* () {
      abortFetcher(key);
      let flushSync2 = (opts && opts.flushSync) === true;
      let routesToUse = inFlightDataRoutes || dataRoutes;
  ...
  function handleFetcherAction(key, routeId, path, match, requestMatches, scopedContext, isFogOfWar, flushSync2, preventScrollReset, submission) {
    return __async(this, null, function* () {
      interruptActiveLoads();
      ...
      let actionResults = yield callDataStrategy(
        fetchRequest,
        fetchMatches,
        scopedContext,
        key
  ...
  function handleFetcherLoader(key, routeId, path, match, matches, scopedContext, isFogOfWar, flushSync2, preventScrollReset, submission) {
    return __async(this, null, function* () {
      let existingFetcher = state.fetchers.get(key);
      updateFetcherState(
        key,
  ...
  function startRedirectNavigation(_0, _1, _2) {
    return __async(this, arguments, function* (request, redirect2, isNavigation, {
      submission,
      fetcherSubmission,
      preventScrollReset,
      replace: replace2
  ...
  function callDataStrategy(request, matches, scopedContext, fetcherKey) {
    return __async(this, null, function* () {
      ...
      let dataResults = {};
      try {
        results = yield callDataStrategyImpl(
          dataStrategyImpl,
          request,
          matches,
          fetcherKey,
      ...
      for (let [routeId, result] of Object.entries(results)) {
        if (isRedirectDataStrategyResult(result)) {
          ...
          dataResults[routeId] = yield convertDataStrategyResultToDataResult(
            result
          );
        }
      }
  ...
  function callLoadersAndMaybeResolveData(matches, fetchersToLoad, request, scopedContext) {
    return __async(this, null, function* () {
      ...
      let fetcherResultsPromise = Promise.all(
        fetchersToLoad.map((f) => __async(null, null, function* () {
      ...
      let loaderResults = yield loaderResultsPromise;
      let fetcherResults = (yield fetcherResultsPromise).reduce(
...
function createStaticHandler(routes, opts) {
  ...
  function query(_0) {
    return __async(this, arguments, function* (request, {
      ...
      if (respond && matches.some(
        ...
        try {
          yield loadLazyMiddlewareForMatches(
            matches,
            manifest,
            mapRouteProperties2
          );
          let renderedStaticContext;
          let response = yield runMiddlewarePipeline(
            {
              request,
              matches,
            ...
            () => __async(null, null, function* () {
              ...
              renderedStaticContext = __spreadValues({ location, basename }, result2);
              let res = yield respond(renderedStaticContext);
              return res;
            }),
            (error, routeId) => __async(null, null, function* () {
              var _a;
              if (isResponse(error)) {
                return error;
              }
  ...
  function queryImpl(request, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, filterMatchesToLoad, skipRevalidation) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        let result = yield loadRouteData(
          request,
          matches,
          requestContext,
          dataStrategy,
  ...
  function submit(request, matches, actionMatch, requestContext, dataStrategy, skipLoaderErrorBubbling, isRouteRequest, filterMatchesToLoad, skipRevalidation) {
    return __async(this, null, function* () {
      ...
      if (isErrorResult(result)) {
        let boundaryMatch = skipLoaderErrorBubbling ? actionMatch : findNearestBoundary(matches, actionMatch.route.id);
        let handlerContext2 = yield loadRouteData(
          loaderRequest,
          matches,
          requestContext,
          dataStrategy,
        ...
        return __spreadProps(__spreadValues({}, handlerContext2), {
          statusCode: isRouteErrorResponse(result.error) ? result.error.status : result.statusCode != null ? result.statusCode : 500,
          actionData: null,
          actionHeaders: __spreadValues({}, result.headers ? { [actionMatch.route.id]: result.headers } : {})
        });
      }
      let handlerContext = yield loadRouteData(
        loaderRequest,
        matches,
        requestContext,
        dataStrategy,
      ...
      return __spreadProps(__spreadValues(__spreadProps(__spreadValues({}, handlerContext), {
        actionData: {
          [actionMatch.route.id]: result.data
        }
  ...
  function loadRouteData(request, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, filterMatchesToLoad, pendingActionResult) {
    return __async(this, null, function* () {
      ...
      return __spreadProps(__spreadValues({}, handlerContext), {
        matches
      });
    });
  }
  function callDataStrategy(request, matches, isRouteRequest, requestContext, dataStrategy) {
    return __async(this, null, function* () {
      let results = yield callDataStrategyImpl(
...
function getMatchesToLoad(request, scopedContext, mapRouteProperties2, manifest, history, state, matches, submission, location, lazyRoutePropertiesToSkip, initialHydration, isRevalidationRequired, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, hasPatchRoutesOnNavigation, pendingActionResult) {
  ...
  let baseShouldRevalidateArgs = __spreadProps(__spreadValues({
    currentUrl,
  ...
  let dsMatches = matches.map((match, index) => {
    ...
    let shouldRevalidateArgs = __spreadProps(__spreadValues({}, baseShouldRevalidateArgs), {
...
var loadLazyRouteProperty = ({
  ...
  let propertyPromise = (() => __async(null, null, function* () {
...
function loadLazyRoute(route, type, manifest, mapRouteProperties2, lazyRoutePropertiesToSkip) {
  ...
  if (typeof route.lazy === "function") {
    ...
    let lazyRoutePromise2 = (() => __async(null, null, function* () {
      invariant(
...
function defaultDataStrategy(args) {
  return __async(this, null, function* () {
    ...
    let keyedResults = {};
    let results = yield Promise.all(matchesToLoad.map((m) => m.resolve()));
...
function runMiddlewarePipeline(args, propagateResult, handler, errorHandler) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      let result = yield callRouteMiddleware(
...
function callRouteMiddleware(args, middlewares, propagateResult, middlewareState, handler, idx = 0) {
  return __async(this, null, function* () {
    let { request } = args;
    if (request.signal.aborted) {
    ...
    if (!tuple) {
      middlewareState.handlerResult = yield handler();
      return middlewareState.handlerResult;
    }
    let [routeId, middleware] = tuple;
    let nextCalled = false;
    let nextResult = void 0;
    let next = () => __async(null, null, function* () {
      if (nextCalled) {
  ...
  return __spreadProps(__spreadValues({}, match), {
    ...
    unstable_shouldCallHandler(defaultShouldRevalidate) {
      ...
      if (typeof defaultShouldRevalidate === "boolean") {
        return shouldRevalidateLoader(match, __spreadProps(__spreadValues({}, unstable_shouldRevalidateArgs), {
          defaultShouldRevalidate
        }));
      }
  ...
  return __async(this, null, function* () {
    ...
    let unstable_runClientMiddleware = isStaticHandler ? () => {
      ...
      return runMiddlewarePipeline(
        ...
        false,
        () => cb(__spreadProps(__spreadValues({}, typedDataStrategyArgs), {
          fetcherKey,
    ...
    let results = yield dataStrategyImpl(__spreadProps(__spreadValues({}, dataStrategyArgs), {
      fetcherKey,
      unstable_runClientMiddleware
    }));
    try {
...
function callLoaderOrAction(_0) {
  return __async(this, arguments, function* ({
    ...
    let runHandler = (handler) => {
      ...
      let handlerPromise = (() => __async(null, null, function* () {
        try {
          let val = yield handlerOverride ? handlerOverride((ctx) => actualHandler(ctx)) : actualHandler();
    ...
    try {
      ...
      if (lazyHandlerPromise || lazyRoutePromise) {
        if (handler) {
          ...
          if (handler2) {
            [result] = yield Promise.all([runHandler(handler2), lazyRoutePromise]);
          } else if (type === "action") {
            let url = new URL(request.url);
      ...
      try {
        ...
        if (contentType && /\bapplication\/json\b/.test(contentType)) {
          if (result.body == null) {
            ...
            data2 = yield result.json();
          }
        } else {
          data2 = yield result.text();
        }
      } catch (e) {
...
function createDeferred() {
  ...
  let promise = new Promise((res, rej) => {
    resolve = (val) => __async(null, null, function* () {
      res(val);
      try {
        yield promise;
      } catch (e) {
    ...
    reject = (error) => __async(null, null, function* () {
      rej(error);
      try {
        yield promise;
      } catch (e) {
...
function useRevalidator() {
  ...
  let revalidate = React2.useCallback(() => __async(null, null, function* () {
  ...
  let navigate = React2.useCallback(
    (_0, ..._1) => __async(null, [_0, ..._1], function* (to, options = {}) {
      ...
      if (typeof to === "number") {
        ...
        yield router2.navigate(to, __spreadValues({ fromRouteId: id }, options));
      }
    }),
    [router2, id]
  );
...
function RouterProvider({
  ...
  React3.useEffect(() => {
    if (renderDfd && pendingState && router2.window) {
      ...
      let transition2 = router2.window.document.startViewTransition(() => __async(null, null, function* () {
        React3.startTransition(() => setStateImpl(newState));
        yield renderPromise;
      }));
...
function decode(readable, options) {
  return __async(this, null, function* () {
    ...
    const decoded = yield decodeInitial.call(decoder, reader);
...
`
            ...
            yield Promise.race(Object.values(encoder2.deferred));
          }
          raceDone();
        }
        yield Promise.all(Object.values(encoder2.deferred));
        controller.close();
      });
    }
  });
...
function getTurboStreamSingleFetchDataStrategy(getRouter, manifest, routeModules, ssr, basename) {
  ...
  return (args) => __async(null, null, function* () {
    return args.unstable_runClientMiddleware(dataStrategy);
  });
}
...
function singleFetchActionStrategy(args, fetchAndDecode, basename) {
  return __async(this, null, function* () {
    let actionMatch = args.matches.find((m) => m.unstable_shouldCallHandler());
    invariant2(actionMatch, "No action match found");
    let actionStatus = void 0;
    let result = yield actionMatch.resolve((handler) => __async(null, null, function* () {
      let result2 = yield handler(() => __async(null, null, function* () {
        let { data: data2, status } = yield fetchAndDecode(args, basename, [
          actionMatch.route.id
        ]);
        actionStatus = status;
...
function nonSsrStrategy(args, getRouteInfo, fetchAndDecode, basename) {
  return __async(this, null, function* () {
    ...
    yield Promise.all(
      matchesToLoad.map(
        (m) => m.resolve((handler) => __async(null, null, function* () {
          try {
            let { hasClientLoader } = getRouteInfo(m);
            let routeId = m.route.id;
            let result = hasClientLoader ? yield handler(() => __async(null, null, function* () {
              let { data: data2 } = yield fetchAndDecode(args, basename, [routeId]);
...
function singleFetchLoaderNavigationStrategy(args, router2, getRouteInfo, fetchAndDecode, ssr, basename) {
  return __async(this, null, function* () {
    ...
    let resolvePromise = Promise.all(
      args.matches.map(
        (m, i) => __async(null, null, function* () {
          return m.resolve((handler) => __async(null, null, function* () {
            routeDfds[i].resolve();
            let routeId = m.route.id;
            ...
            if (hasClientLoader) {
              ...
              try {
                let result = yield handler(() => __async(null, null, function* () {
                  let { data: data2 } = yield fetchAndDecode(args, basename, [routeId]);
                  return unwrapSingleFetchResult(data2, routeId);
                }));
            ...
            try {
              let result = yield handler(() => __async(null, null, function* () {
                let data2 = yield singleFetchDfd.promise;
                return unwrapSingleFetchResult(data2, routeId);
              }));
              results[routeId] = { type: "data", result };
            } catch (e) {
    ...
    if ((isInitialLoad || routesParams.size === 0) && !window.__reactRouterHdrActive) {
      ...
      try {
        let data2 = yield fetchAndDecode(args, basename, targetRoutes);
...
function bubbleMiddlewareErrors(singleFetchPromise, matches, routesParams, results) {
  return __async(this, null, function* () {
    try {
      let middlewareError;
      let fetchedData = yield singleFetchPromise;
...
function singleFetchLoaderFetcherStrategy(args, fetchAndDecode, basename) {
  return __async(this, null, function* () {
    let fetcherMatch = args.matches.find((m) => m.unstable_shouldCallHandler());
    invariant2(fetcherMatch, "No fetcher match found");
    let routeId = fetcherMatch.route.id;
    let result = yield fetcherMatch.resolve(
      (handler) => __async(null, null, function* () {
        return handler(() => __async(null, null, function* () {
          let { data: data2 } = yield fetchAndDecode(args, basename, [routeId]);
          return unwrapSingleFetchResult(data2, routeId);
        }));
      })
...
function fetchAndDecodeViaTurboStream(args, basename, targetRoutes) {
  return __async(this, null, function* () {
    let { request } = args;
    ...
    let res = yield fetch(url, yield createRequestInit(request));
    ...
    try {
      let decoded = yield decodeViaTurboStream(res.body, window);
      let data2;
      if (request.method === "GET") {
...
function unwrapSingleFetchResult(result, routeId) {
  if ("redirect" in result) {
    ...
    throw redirect(location, {
      status,
      headers: __spreadValues(__spreadValues(__spreadValues({}, revalidate ? { "X-Remix-Revalidate": "yes" } : null), reload ? { "X-Remix-Reload-Document": "yes" } : null), replace2 ? { "X-Remix-Replace": "yes" } : null)
    });
  }
...
function createClientRoutes(manifest, routeModulesCache, initialState, ssr, isSpaMode, parentId = "", routesByParentId = groupRoutesByParentId(manifest), needsRevalidation) {
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    if (routeModule) {
      ...
      dataRoute.loader = (_0, _1) => __async(null, [_0, _1], function* ({ request, params, context }, singleFetch) {
        try {
          let result = yield prefetchStylesAndCallHandler(() => __async(null, null, function* () {
            invariant2(
              routeModule,
      ...
      dataRoute.action = ({ request, params, context }, singleFetch) => {
        return prefetchStylesAndCallHandler(() => __async(null, null, function* () {
          invariant2(
            routeModule,
      ...
      function getLazyRoute() {
        return __async(this, null, function* () {
          ...
          lazyRoutePromise = (() => __async(null, null, function* () {
      ...
      dataRoute.lazy = {
        loader: route.hasClientLoader ? () => __async(null, null, function* () {
          let { clientLoader } = route.clientLoaderModule ? yield import(
            /* @vite-ignore */
            /* webpackIgnore: true */
            route.clientLoaderModule
          ) : yield getLazyRoute();
          invariant2(clientLoader, "No `clientLoader` export found");
          return (args, singleFetch) => clientLoader(__spreadProps(__spreadValues({}, args), {
            serverLoader() {
              return __async(this, null, function* () {
                preventInvalidServerHandlerCall("loader", route);
                return fetchServerLoader(singleFetch);
        ...
        action: route.hasClientAction ? () => __async(null, null, function* () {
          ...
          prefetchRouteModuleChunks(route);
          let { clientAction } = yield clientActionPromise;
          invariant2(clientAction, "No `clientAction` export found");
          return (args, singleFetch) => clientAction(__spreadProps(__spreadValues({}, args), {
            serverAction() {
              return __async(this, null, function* () {
                preventInvalidServerHandlerCall("action", route);
                return fetchServerAction(singleFetch);
        ...
        unstable_middleware: route.hasClientMiddleware ? () => __async(null, null, function* () {
          let { unstable_clientMiddleware } = route.clientMiddlewareModule ? yield import(
            /* @vite-ignore */
            /* webpackIgnore: true */
        ...
        shouldRevalidate: () => __async(null, null, function* () {
          let lazyRoute = yield getLazyRoute();
        ...
        handle: () => __async(null, null, function* () {
          return (yield getLazyRoute()).handle;
        }),
        // No need to wrap these in layout since the root route is never
        // loaded via route.lazy()
        Component: () => __async(null, null, function* () {
          return (yield getLazyRoute()).Component;
        }),
        ErrorBoundary: route.hasErrorBoundary ? () => __async(null, null, function* () {
...
function getShouldRevalidateFunction(path, route, manifestRoute, ssr, needsRevalidation) {
  ...
  if (!ssr && manifestRoute.hasLoader && !manifestRoute.hasClientLoader) {
    ...
    if (route.shouldRevalidate) {
      ...
      return (opts) => fn(__spreadProps(__spreadValues({}, opts), {
...
function loadRouteModuleWithBlockingLinks(route, routeModules) {
  return __async(this, null, function* () {
    ...
    let routeModule = yield routeModulePromise;
    yield Promise.all([
...
function getPartialManifest(_a, router2) {
  var _b = _a, { sri } = _b, manifest = __objRest(_b, ["sri"]);
...
function getPatchRoutesOnNavigationFunction(manifest, routeModules, ssr, routeDiscovery, isSpaMode, basename) {
  ...
  return (_0) => __async(null, [_0], function* ({ path, patch, signal, fetcherKey }) {
...
function fetchAndApplyManifestPatches(paths, errorReloadPath, manifest, routeModules, ssr, isSpaMode, basename, manifestPath, patchRoutes, signal) {
  return __async(this, null, function* () {
    ...
    let serverPatches;
    try {
      let res = yield fetch(url, { signal });
      if (!res.ok) {
...
function Links() {
  ...
  return React9.createElement(React9.Fragment, null, typeof criticalCss === "string" ? React9.createElement("style", { dangerouslySetInnerHTML: { __html: criticalCss } }) : null, typeof criticalCss === "object" ? React9.createElement("link", { rel: "stylesheet", href: criticalCss.href }) : null, keyedLinks.map(
    ({ key, link }) => isPageLinkDescriptor(link) ? React9.createElement(PrefetchPageLinks, __spreadValues({ key }, link)) : React9.createElement("link", __spreadValues({ key }, link))
  ));
}
...
function PrefetchPageLinksImpl(_a) {
  ...
  return React9.createElement(React9.Fragment, null, dataHrefs.map((href2) => React9.createElement("link", __spreadValues({ key: href2, rel: "prefetch", as: "fetch", href: href2 }, linkProps))), moduleHrefs.map((href2) => React9.createElement("link", __spreadValues({ key: href2, rel: "modulepreload", href: href2 }, linkProps))), keyedPrefetchLinks.map(({ key, link }) => (
    ...
    React9.createElement("link", __spreadValues({ key }, link))
  )));
}
function Meta() {
...
var Link = React10.forwardRef(
  function LinkWithRef(_a, forwardedRef) {
    var _b = _a, {
      onClick,
      discover = "render",
      prefetch = "none",
...
var NavLink = React10.forwardRef(
  function NavLinkWithRef(_a, ref) {
    var _b = _a, {
  ...
  return React10.useCallback(
    (_0, ..._1) => __async(null, [_0, ..._1], function* (target, options = {}) {
      ...
      if (options.navigate === false) {
        ...
        yield router2.fetch(key, currentRouteId, options.action || action, {
        ...
        yield router2.navigate(options.action || action, {
          preventScrollReset: options.preventScrollReset,
          formData,
          body,
          formMethod: options.method || method,
...
function useFetcher({
  ...
  let load = React10.useCallback(
    (href2, opts) => __async(null, null, function* () {
      invariant(routeId, "No routeId available for fetcher.load()");
      yield router2.fetch(fetcherKey, routeId, href2, opts);
    }),
    [fetcherKey, routeId, router2]
  );
  let submitImpl = useSubmit();
  let submit = React10.useCallback(
    (target, opts) => __async(null, null, function* () {
      yield submitImpl(target, __spreadProps(__spreadValues({}, opts), {
        navigate: false,
        fetcherKey
      }));
    }),
...
var sign = (value, secret) => __async(null, null, function* () {
  let data2 = encoder.encode(value);
  let key = yield createKey2(secret, ["sign"]);
  let signature = yield crypto.subtle.sign("HMAC", key, data2);
...
var unsign = (cookie, secret) => __async(null, null, function* () {
  let index = cookie.lastIndexOf(".");
  let value = cookie.slice(0, index);
  let hash = cookie.slice(index + 1);
  let data2 = encoder.encode(value);
  let key = yield createKey2(secret, ["verify"]);
  let signature = byteStringToUint8Array(atob(hash));
  let valid = yield crypto.subtle.verify("HMAC", key, signature, data2);
  return valid ? value : false;
});
var createKey2 = (secret, usages) => __async(null, null, function* () {
      ...
      return __async(this, null, function* () {
        ...
        if (name in cookies) {
          ...
          if (typeof value === "string" && value !== "") {
            let decoded = yield decodeCookieValue(value, secrets);
            return decoded;
          } else {
            return "";
          }
    ...
    serialize(value, serializeOptions) {
      return __async(this, null, function* () {
        return (0, import_cookie.serialize)(
          name,
          value === "" ? "" : yield encodeCookieValue(value, secrets),
          __spreadValues(__spreadValues({}, options), serializeOptions)
        );
      });
    }
  };
...
function encodeCookieValue(value, secrets) {
  return __async(this, null, function* () {
    ...
    if (secrets.length > 0) {
      encoded = yield sign(encoded, secrets[0]);
    }
    return encoded;
  });
}
  ...
  return __async(this, null, function* () {
    if (secrets.length > 0) {
      for (let secret of secrets) {
        let unsignedValue = yield unsign(value, secret);
...
function callRouteHandler(handler, args) {
  return __async(this, null, function* () {
...
function createStaticHandlerDataRoutes(manifest, future, parentId = "", routesByParentId = groupRoutesByParentId2(manifest)) {
  return (routesByParentId[parentId] || []).map((route) => {
    let commonRoute = {
      ...
      loader: route.module.loader ? (args) => __async(null, null, function* () {
        ...
        if (preRenderedData != null) {
          ...
          let decoded = yield decodeViaTurboStream(stream, global);
        ...
        let val = yield callRouteHandler(route.module.loader, args);
        return val;
      }) : void 0,
...
function singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
  return __async(this, null, function* () {
    try {
      ...
      let result = yield staticHandler.query(handlerRequest, {
...
function singleFetchLoaders(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
  return __async(this, null, function* () {
    try {
      let respond2 = function(context) {
        let headers = getDocumentHeaders(build, context);
...
var createRequestHandler = (build, mode) => {
  ...
  let staticHandler;
  let errorHandler;
  return function requestHandler(request, initialContext) {
    return __async(this, null, function* () {
      var _a, _b, _c;
      _build = typeof build === "function" ? yield build() : build;
...
Error: ${e instanceof Error ? e.toString() : e}`
      ...
      if (url.pathname === manifestUrl) {
        try {
          let res = yield handleManifestRequest(_build, routes, url);
          return res;
        } catch (e) {
          handleError(e);
      ...
      if (url.pathname.endsWith(".data")) {
        ...
        response = yield handleSingleFetchRequest(
          serverMode,
          _build,
          staticHandler,
          request,
        ...
        if (_build.entry.module.handleDataRequest) {
          response = yield _build.entry.module.handleDataRequest(response, {
            context: loadContext,
        ...
        response = yield handleResourceRequest(
          serverMode,
          _build,
          staticHandler,
        ...
        if (_build.unstable_getCriticalCss) {
          criticalCss = yield _build.unstable_getCriticalCss({ pathname });
        } else if (mode === "development" && ((_a = getDevServerHooks()) == null ? void 0 : _a.getCriticalCss)) {
          criticalCss = yield (_c = (_b = getDevServerHooks()) == null ? void 0 : _b.getCriticalCss) == null ? void 0 : _c.call(_b, pathname);
        }
        response = yield handleDocumentRequest(
          serverMode,
          _build,
          staticHandler,
          request,
...
function handleManifestRequest(build, routes, url) {
  return __async(this, null, function* () {
...
function handleSingleFetchRequest(serverMode, build, staticHandler, request, handlerUrl, loadContext, handleError) {
  return __async(this, null, function* () {
    let response = request.method !== "GET" ? yield singleFetchAction(
      build,
      serverMode,
      staticHandler,
      request,
...
function handleDocumentRequest(serverMode, build, staticHandler, request, loadContext, handleError, isSpaMode, criticalCss) {
  return __async(this, null, function* () {
    try {
      let response = yield staticHandler.query(request, {
        requestContext: loadContext,
    ...
    function renderHtml(context, isSpaMode2) {
      return __async(this, null, function* () {
        ...
        let entryContext = {
          ...
          criticalCss,
          serverHandoffString: createServerHandoffString(__spreadProps(__spreadValues({}, baseServerHandoff), {
            criticalCss
          })),
        ...
        try {
          return yield handleDocumentRequestFunction(
            request,
            context.statusCode,
            headers,
            entryContext,
          ...
          if (isResponse(error)) {
            try {
              let data2 = yield unwrapResponse(error);
...
function handleResourceRequest(serverMode, build, staticHandler, routeId, request, loadContext, handleError) {
  return __async(this, null, function* () {
    try {
      let response = yield staticHandler.queryRoute(request, {
        routeId,
        requestContext: loadContext,
...
function createSessionStorage({
  ...
  return {
    getSession(cookieHeader, options) {
      return __async(this, null, function* () {
        let id = cookieHeader && (yield cookie.parse(cookieHeader, options));
        let data2 = id && (yield readData(id));
    ...
    commitSession(session, options) {
      return __async(this, null, function* () {
        ...
        if (id) {
          yield updateData(id, data2, expires);
        } else {
          id = yield createData(data2, expires);
        }
        return cookie.serialize(id, options);
      });
    },
    destroySession(session, options) {
      return __async(this, null, function* () {
        yield deleteData(session.id);
...
function createCookieSessionStorage({ cookie: cookieArg } = {}) {
  ...
  return {
    getSession(cookieHeader, options) {
      return __async(this, null, function* () {
        return createSession(
          cookieHeader && (yield cookie.parse(cookieHeader, options)) || {}
        );
      });
    },
    commitSession(session, options) {
      return __async(this, null, function* () {
        let serializedCookie = yield cookie.serialize(session.data, options);
    ...
    destroySession(_session, options) {
      return __async(this, null, function* () {
        return cookie.serialize("", __spreadProps(__spreadValues({}, options), {
          maxAge: void 0,
          expires: /* @__PURE__ */ new Date(0)
...
function getHydrationData(state, routes, getRouteInfo, location, basename, isSpaMode) {
  let hydrationData = __spreadProps(__spreadValues({}, state), {
    loaderData: __spreadValues({}, state.loaderData)
  });
