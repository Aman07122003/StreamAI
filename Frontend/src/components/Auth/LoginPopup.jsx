        ...
        createPortal(
          ...
          >
            <div className="mx-8 my-6 mb-8 flex flex-col relative  ">
              ...
              <Logo className="left-0 absolute" />
              </div>
              <h6 className="mx-auto mt-8 mb-2 text-2xl font-semibold">{message}</h6>
              ...
              <form
                ...
                className="mx-auto mt-5 flex w-full flex-col px-4 gap-y-2"
              >
                <Input
